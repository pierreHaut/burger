...
dump($credentials['login'], $user);
    ...
    {
        dump($credentials['login'], 'isvalide',  $this->passwordEncoder->isPasswordValid($user, $credentials['password']));
         dump(__METHOD__);
    ...
    public function onAuthenticationSuccess(Request $request, TokenInterface $token, $providerKey)
    {
         ...
         return new RedirectResponse($this->router->generate('burger_index'));
